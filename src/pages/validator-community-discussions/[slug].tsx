...
const placeholderSEO: NextSeoProps = {
  title: "Watch the Validator Community Discussion",
  description: "",
};
  ...
  return (
    <DefaultLayout seo={{ ...placeholderSEO, ...seo }}>
      <PageHero className="container text-center">
        ...
        <section className={heroStyles.ctaSection}>
          ...
          >
            ...
            Back to Validator Discussions
          </Link>
          <Link
            target="_blank"
            href={shareOnTwitterUrl({
              href: `${ROUTE_BASE}/${record.SK}`,
              message: `Checkout the @solana Validator Community Discussion from ${record.PublishedAt}`,
            })}
      ...
      <main className={"max-w-4xl container"}>
        ...
        <NextPrevButtons
          nextHref={`${ROUTE_BASE}/${nextSlug || ""}`}
          prevHref={`${ROUTE_BASE}/${prevSlug || ""}`}
          nextLabel={
            nextSlug
              ? "Next Validator Community Discussion"
              : "All Validator Community Discussions"
          }
          prevLabel={
            prevSlug
              ? "Previous Validator Community Discussion"
              : "All Validator Community Discussions"
          }
        />
      </main>
