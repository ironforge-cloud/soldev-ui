				...
				<div className="flex flex-col space-y-3 md:space-x-3 md:space-y-0">
					<div className="flex-1">
						...
						<div className="mt-3 max-w-2xl">
							The SolDev Validator's mission is to support developers' journey
							into the Solana Ecosystem by providing grants to developers who
							are contributing to open source or creating high-quality developer
							content.
						</div>
					</div>
					...
					<div className="flex-1">
						...
						<div className="mt-3 max-w-2xl">
							The SolDev Validator will start giving grants when it reaches
							profitability. More information will be shared on this page about
							the grant process and validator profitability status soon.
						</div>
						...
						<div className="mt-3 max-w-2xl">
							...
							<ul className="list-disc space-y-3 pl-5">
								...
								<li>
									<Link
										href="https://github.com/jito-foundation/stakenet"
										target="_blank"
									>
										Stakenet
									</Link>
								...
								<li>
									<Link
										href="https://github.com/ironforge-cloud/soldev-ui"
										target="_blank"
									>
										SolDev
									</Link>
					...
					<div className="flex-1">
						...
						<div className="mt-3 max-w-2xl">
							To delegate to the SolDev Validator, you can do it directly using
							a wallet like{" "}
					...
					<div className="flex-1">
						...
						<div className="mt-3 max-w-2xl">
							The SolDev Validator's fees will be used to cover the server and
					...
					<div className="flex-1">
						...
						<div className="mt-3 max-w-2xl">
							Our validator server is well-equipped to handle heavy loads and
							spam attacks that affect lesser systems.
							<ul className="list-disc space-y-3 pl-5">
								<li>Client: Jito</li>
					...
					<div className="flex-1">
						...
						<div className="mt-3 max-w-2xl">
							For security, we follow Solana's recommended practices and have
							strong DDOS protection from our datacenter. We also have a
							quick-alert monitoring system for any issues with server
							performance.
						</div>
					</div>
				</div>
