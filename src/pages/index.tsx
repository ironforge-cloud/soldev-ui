...
export async function getStaticProps() {
    ...
    superteamEcosystemCalls[superteamEcosystemCalls.length - 1].Url = `/library/playlist/${'superteam-ecosystem-calls'}/${
        superteamEcosystemCalls[superteamEcosystemCalls.length - 1].SK
    }`;
    ...
    latestPosts.push(
        ...
        superteamEcosystemCalls[superteamEcosystemCalls.length - 1]
    );
