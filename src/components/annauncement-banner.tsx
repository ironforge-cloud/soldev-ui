...
export default function AnnauncementBanner() {
    return (
        <div
            className="relative w-fit mx-auto rounded-3xl isolate flex items-center gap-x-6 overflow-hidden bg-gradient-to-r from-[#14F195] to-[#9945FF] px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
            <div
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                <p className="text-sm leading-6 text-gray-900">
                    <strong className="font-semibold">Encode Club x Solana</strong>
                    <svg viewBox="0 0 2 2" className="mx-2 inline h-0.5 w-0.5 fill-current"
                         aria-hidden="true">
                        <circle cx={1} cy={1} r={1}/>
                    </svg>
                    A Bootcamp and Hackathon sponsored by the Solana Foundation
                </p>
                <Link
                    href="https://www.encode.club/solana"
                    target="_blank"
